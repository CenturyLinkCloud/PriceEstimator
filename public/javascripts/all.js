...
if (this.model.get("type") === "hyperscale") {
  $o.push("<input type='hidden' name='type' value='hyperscale'>");
} else {
  $o.push("<input type='hidden' name='type' value='standard'>");
}
